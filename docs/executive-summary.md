...
| :--- | :--- | :--- | :--- |
| **Free Tier** | **$0.05** | 3 Analyses | Gemini 3 Flash API, Firebase Storage |
| **Paid Tier** | **$0.50** | 50 Analyses | Increased AI tokens, Historical tracking |

**Key Takeaway**: The marginal cost of supporting a user is extremely low, allowing for high gross margins (>90%) even at the $49/mo price point.

---

### 📊 ROI & TCO (Total Cost of Ownership)

#### Total Cost of Ownership (TCO) - Conservative
- **Software**: $0 - $50/mo (Firebase free tier, Gemini pay-as-you-go).
- **Maintenance**: 2-4 hours/week for SuperAdmin monitoring.
- **Support**: Minimal (automated password resets, documentation).

#### Expected ROI (Year 1)
- **Revenue Target**: $10,000 - $50,000 (Conservative, targeting 20-100 Pro users).
- **ROI Benefit**: High. The "Blue Ocean" nature of AEO means low customer acquisition costs (CAC) through organic authority building.
...
- **Crawl Blocking**: Large sites may block our crawler (mitigated by our server-side proxy).
...
3. **Stripe Live**: Move from mock payments to live production keys.
