...
#### For Users & Clients
*   **Q: What is AEO?**
    *   **A**: Answer Engine Optimization (AEO) is the process of optimizing your website content so that AI agents (like Gemini, ChatGPT, and Perplexity) can easily find, understand, and cite your information as the primary source for their answers.
...
*   **Q: How do I manage users who have lost their passwords?**
    *   **A**: Go to the **Admin Dashboard** (accessible via the sidebar if you are logged in as an admin). You can search for the user and click "Reset Password" to send them an automated email.
*   **Q: How can I see how many people are using the app right now?**
    *   **A**: The Admin Dashboard provides real-time metrics on total users and subscription status. For detailed real-time traffic, click the "Open GA4" link in the dashboard.
*   **Q: What should I do if the AI analysis seems slow?**
