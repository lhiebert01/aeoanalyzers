...
export default function MarketingLanding({ onGetStarted }: MarketingLandingProps) {
  ...
  const faqs = [
    ...
    {
      q: "Is it AEO or GEO? Isn't GEO newer and better?",
      a: "They're two names for the same thing. GEO (Generative Engine Optimization) comes from a 2023 academic paper; AEO (Answer Engine Optimization) comes from the SEO world — and you'll also hear LLMO, AIO, and 'AI SEO'. All describe one goal: being the source AI engines cite when they answer. So if someone sells you an 'Answer Engine Optimization' by a different name — GEO, LLMO, AIO, or 'AI SEO' — you can confidently know it's the same thing with the same goal. The things you actually optimize are identical: structured data, citable facts, a clear entity identity, crawlability, and authority the engines already trust. Anyone telling you 'you don't need AEO, you need GEO' is selling a relabel, not a different practice. What actually matters is the outcome — do the engines cite you? — and that is exactly what AEO Analyzers measures directly with live Citation Sweeps, whatever you call the category."
    },
    {
